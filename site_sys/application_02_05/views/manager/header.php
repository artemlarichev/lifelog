	...
	<div class="header_wrap" style="background: url('<?=$this->data->rand_banner()?>') no-repeat scroll 50% 86px transparent; " >
		...
		<ul class="list_link">
			<li><a href="/shops" title="Наши магазины">Наши магазины</a>
				<a class="edit_ico" href="/manager/edit_page/shops" title=""></a>

			</li>
			<li><a href="/order" title="Заказ и доставка">Заказ и доставка</a>
				<a class="edit_ico" href="/manager/edit_page/order" title=""></a>
		...
		<div class="manager_menu mod_2">
			<ul class="m_m1_category">
				<li>
					<a  <?if ($action == 'orders' and  isset($this->conf['client'])) { ?> class="mark"<? }?> href="/client/orders/0/1" title="Заказы">Заказы</a>
				</li>
				<li>
					<a  <?if ($action == 'balance') { ?> class="mark"<? }?> href="/client/balance" title="Баланс">Баланс</a>
				</li>

				<li>
					<a  <?if ($action == 'search_history') { ?> class="mark"<? }?> href="/client/search_history" title="История поиска">История
						поиска</a></li>
				<li>
					<a <?if ($action == 'account') { ?> class="mark"<? }?>  href="/client/account" title="Карточка клиента">Карточка
						клиента</a></li>
