							...
							<tbody>
								...
								if ($edit_act == '0' and isset($_SESSION['manager'])) {
									...
									<tr class="table_edit_row">
										...
										<td>
											<div class="input_wrap">
												<select name='type' id='type' onchange="SelTypeBal();return false ">
									...
									if ($edit_act == $pay['id'] and  isset($_SESSION['manager'])) {
										...
										<tr>
											...
											<?if($pay['order_id']>0){?><a href='/<?if(isset($_SESSION['manager'])){?>manager<?}else{?>client<?}?>/order/<?=$pay['order_id']?>'>Заказ №<?=$pay['order_id']?></a> <?}?>
                                                    ...
                                                    <button onclick="SaveText(<?=$pay['id']?>,'text',<?=$pay['order_id']?>);return false">>></button>
                                                    </DIV>
                                    
                                                    
                                                     <a title="" href="#" class="edit_ico" onclick="EditText(<?=$pay['id']?>,'text');return false"></a>
                                            ...
                                            <span id='text_nakladna_<?=$pay['id']?>'><?=$pay['nakladna']?></span>
                                                    ...
                                                    <button onclick="SaveText(<?=$pay['id']?>,'nakladna',<?=$pay['order_id']?>);return false">>></button>
                                                    </DIV>
                                    
                                                    
                                                     <a title="" href="#" class="edit_ico" onclick="EditText(<?=$pay['id']?>,'nakladna');return false"></a>
                                        ...
                                        <button onclick="SaveText(<?=$pay['id']?>,'decl',<?=$pay['order_id']?>);return false">>></button>
                                        </DIV>
                                        <a title="" href="#" class="edit_ico" onclick="EditText(<?=$pay['id']?>,'decl');return false"></a>
                                        ...
                                        <button onclick="SaveText(<?=$pay['id']?>,'platig',<?=$pay['order_id']?>);return false">>></button>
                                        </DIV>
                                        <a title="" href="#" class="edit_ico" onclick="EditText(<?=$pay['id']?>,'platig');return false"></a>
                                        ...
                                        <button onclick="SaveText(<?=$pay['id']?>,'perevod',<?=$pay['order_id']?>);return false">>></button>
                                        </DIV>
                                        <a title="" href="#" class="edit_ico" onclick="EditText(<?=$pay['id']?>,'perevod');return false"></a>
