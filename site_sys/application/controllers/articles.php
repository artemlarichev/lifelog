<?php
    //Текстовые статьи на сайте 
    class Articles extends Controller {

        var  $conf=array('client'=>'1','page'=>'cab');  
        ...
        function edit_cat($id=0) {
            ...
            if($this->input->post('title')){
              ...
              return  header("location:/articles/{$this->input->post('url')}");                                              
            }                                             
            $data['cats'] = $this->article->get_cats(); 
        ...
        function del($type,$id) { 
            if(!isset($_SESSION['manager'])) return header("location:/articles");             
