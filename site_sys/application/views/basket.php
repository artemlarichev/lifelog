...
<?php  $this->load->view('page_elements/order_box_basket');  ?>
					...
					<div class="big_table_wrap">
							 ...
							 ?>
                               ...
                               <tr  class="table_check_row_prepare">
                                    <td>
                                     ...
                                     <td>  <?=$val['desc']?></td>
                                     <td class="numeric">
                                    <?=$this->catalog_model->get_price_ukr($val,$this->conf['kurs'],$this->conf['discont'])?></td>
                                        <td class="hdd" width='20px'  style='display:none;text-align:right' ><span id='nal_<?=$count?>'></span> </td>
                                     ...
                                     <input type="hidden" name='price_<?=$count?>'  id='price_<?=$count?>' value='<?=$this->catalog_model->get_price_ukr($val,$this->conf['kurs'],$this->conf['discont'])?>'>
                                      <input type="hidden" name='amount_<?=$count?>'  id='amount_<?=$count?>' value='<?=$val['count']?>'></td>


                                     <td class="numeric"><div id='suma_<?=$count?>'>
                                     <?=$this->catalog_model->get_price_ukr($val,$this->conf['kurs'],$this->conf['discont'])*$val['bascet_count']*$val['in_order']?>
                                     </div></td>
                                     <td>
                                     <input type="checkbox" value="1" id='in_order_<?=$count?>' 
                                     <?if($val['in_order']>0){?>
                               ...
                               <tr  class="table_check_row_prepare">
                                   ...
                                   <?=$val['PartNameEng']?>
                                    ...
                                    <?=$val['price_end'] ?></td>
                                     ...
                                     <td> 
                                        <a title="" href="#" id="edit_basket" onclick='Show_edit_block_basket(<?=$count?>,"<?=$val['id']?>2_mp");return false' class="edit_ico"></a>
                                     </td>
                                     <td><a href='/catalog/del/<?=$val['id'].$val['type']?>'><span class="t_del">х</span></a></td>
                                </tr>
						...
						<div class="basket_info">
							<dl class="basket_user_form">
								...
								value='<?if(isset($_SESSION['user']['name'])) {echo $_SESSION['user']['fullname']." ".$_SESSION['user']['name'];}?>'></dd>
								...
								value='<?if(isset($_SESSION['user']['email'])) {echo $_SESSION['user']['email'];}?>'
								></dd>
