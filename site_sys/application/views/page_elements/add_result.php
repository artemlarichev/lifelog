...
<thead>
    ...
    <tr  class="table_check_row_prepare">
        ...
        <td><?=$val['count']?></td>
         ...
         <td class="numeric">
       <?=$this->catalog_model->get_price_ukr($val,$this->conf['kurs'],$this->conf['discont'])?>
                                     ...
                                     <input type="hidden" name='price_ukr_<?=$count2?>'  id='price_ukr_<?=$count2?>' value='<?=$this->catalog_model->get_price_ukr($val,$this->conf['kurs'],$this->conf['discont'])?>'>
