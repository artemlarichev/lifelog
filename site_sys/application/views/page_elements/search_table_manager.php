							 ...
							 ?>
                                ...
                                <?if(sizeof($user_fields)>0){
                                     ...
                                     elseif($field=='price_uah' or $field=='price_usd')
                                    {
                                     ...
                                     print ("<td>".$this->catalog_model->get_price($val,$valuta,$this->conf['nacenka'])."</td>");
                                    }
                                ...
                                <?}else{ ?>
									<td>
								 	...
								 	<td><?=$val['manuf']?></td>
								 	<td><?=$val['car_desc']?></td>
								 	<td class="numeric"> <?=$this->catalog_model->get_price($val,$_SESSION['valuta'],$this->conf['nacenka'])?></td>
