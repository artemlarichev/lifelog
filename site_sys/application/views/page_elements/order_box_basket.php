	...
	<div class="order_box">
		...
		<div class="ob_form">
				...
				<div class="obf_count">
					...
					<input class="obf_inp" type="text" id="obf_count" value="1" onkeyup="refresh_edit_box_price();">
				...
				<div class="obf_submit_w">
					<input   type="button" onclick="update_basket()" class="obf_submit" value="Сохранить">
				</div>
