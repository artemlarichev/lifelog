...
<div class="content_row">
				<div class="main_table_wrap">
					...
					<div class="big_table_wrap">
						<table class="big_table table">
							...
							<tbody>
								<tr class="table_check_row_prepare">
									<td>
										<a title="<?=hide_value($part['DetailNum'])?>" href=""><?=hide_value($part['DetailNum'])?></a>
									</td>
									<td><?=$this->catalog_model->MakeLogoName($part['MakeLogo'])?></td>
									<td><?=$part['DetailName']?> </td>
									<td class="numeric">
                                  <a href="#"  onclick="findRandKey('<?=$part['DetailNum']?>')"> Узнать цену</a>
                                    </td>
                        ...
                        <? $image= $this->data->get_image_by_article($part['DetailNum']);
